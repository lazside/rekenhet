...
import { calculateNetSalary, berekenUurloonProjecties, type BrutoNettoBreakdown } from "./compute";
    ...
    <div className="grid grid-cols-3 gap-3 mt-3">
      {projecties.map((p) => (
        <div key={p.urenPerWeek} className="rounded-lg bg-gradient-to-b from-blue-50 to-white border border-blue-100 p-3 text-center">
          <p className="text-[10px] text-blue-600 font-medium uppercase tracking-wider">{p.urenPerWeek} uur</p>
          <p className="text-sm font-bold text-blue-700 tabular-nums mt-0.5">{formatEUR(p.nettoMaand)}/mnd</p>
    ...
    <div className="space-y-5" role="form" aria-label="Bruto netto salaris calculator">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 p-6 text-white shadow-lg">
          ...
          <div className="relative">
            ...
            <div className="flex items-center gap-4 mt-3 flex-wrap">
              <span className="text-xs text-blue-200">Effectief: <strong className="text-white">{breakdown.effectiveRate}%</strong></span>
              <span className="text-xs text-blue-200">Marginaal: <strong className="text-white">{breakdown.marginalRate}%</strong></span>
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
        ...
        <div className="flex items-center gap-1 text-white text-[10px] font-medium overflow-x-auto pb-1">
          ...
          <div className="rounded-lg bg-blue-400 px-3 py-2 shrink-0">Vak.</div>
          <div className="h-0.5 w-3 bg-gray-300 shrink-0" />
      ...
      <details className="group rounded-xl border border-gray-200 bg-white shadow-sm">
        <summary className="flex cursor-pointer items-center justify-between px-5 py-4 text-sm font-medium text-gray-700 hover:text-blue-600">
          <span className="flex items-center gap-2"><Clock className="h-4 w-4 text-blue-500" />Uurloon → maandinkomen projectie</span>
          <span className="text-xs text-gray-400 transition-transform group-open:rotate-180">▼</span>
        </summary>
      ...
      {showCbs && (
        <details className="group rounded-xl border border-gray-200 bg-white shadow-sm open:border-blue-200 transition-all">
          <summary className="flex cursor-pointer items-center justify-between px-5 py-4 text-sm font-medium text-gray-700 hover:text-blue-600">
            <span className="flex items-center gap-2"><Users className="h-4 w-4 text-blue-500" />CBS Benchmark</span>
            <span className="text-xs text-gray-400 transition-transform group-open:rotate-180">▼</span>
          </summary>
