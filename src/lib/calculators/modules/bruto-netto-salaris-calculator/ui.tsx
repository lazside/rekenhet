  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        ...
        <input id="benchmark-age" type="number" min={18} max={99} value={age} onChange={(e) => setAge(Number(e.target.value) || 35)} className="w-20 rounded-lg border border-gray-300 px-3 py-1.5 text-sm text-center focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20" />
