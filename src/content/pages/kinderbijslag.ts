...
registerPages({
  slug: "kinderbijslag",
  seo: {
    title: "Kinderbijslag Berekenen 2026 | Rekenhet.nl",
    description: "Gratis kinderbijslag calculator voor 2026.",
    h1: "Kinderbijslag Berekenen — Bereken het eenvoudig en snel",
    intro: "Of het nu gaat om belasting, spaargeld of verzekeringen — met deze Kinderbijslag Berekenen weet je waar je aan toe bent. Bereken de kinderbijslag op basis van het aantal kinderen en kwartaal. De calculator werkt met de actuele 2026-tarieven en -regels, zodat je altijd een reëel beeld krijgt.",
    ...
    keywords: ["kinderbijslag","kindgebonden budget","kinderen","toeslag","svb","kinderbijslag 2026"],
  },
  calculator: {
    componentSlug: "kinderbijslag",
    categorySlug: "geld-en-verzekeringen",
  },
  categoryLabel: "Geld & Verzekeringen",
  faqs: [
  {
    "question": "Wat is Kinderbijslag Berekenen en hoe gebruik ik hem?",
    "answer": "Kinderbijslag Berekenen is een gratis online tool waarmee je bereken de kinderbijslag op basis van het aantal kinderen en kwartaal. Je vult de gevraagde gegevens in en het resultaat verschijnt direct. De calculator werkt met de meest actuele gegevens en tarieven, zodat je altijd een reële uitkomst krijgt. Geen registratie nodig en volledig gratis te gebruiken."
  },
  {
  ...
  {
    "question": "In welke situaties gebruik ik Kinderbijslag Berekenen?",
  ...
  },
  {
    ...
    "answer": "Naast Kinderbijslag Berekenen zijn er op Rekenhet.nl nog meer handige calculators die je kunt gebruiken. Kijk ook eens naar de andere tools in de categorie Geld & Verzekeringen. Ze vullen elkaar aan en geven je een completer beeld van je situatie."
  }
],
});
