...
registerPages({
  slug: "waterbehoefte",
  seo: {
    title: "Waterbehoefte Berekenen — Dagelijkse Vocht | Rekenhet.nl",
    description: "Gratis waterbehoefte calculator. Bereken hoeveel water je dagelijks moet drinken.",
    h1: "Waterbehoefte Berekenen — Direct inzicht in je gezondheid",
    intro: "Een gezonde leefstijl begint met inzicht. Deze Waterbehoefte Berekenen geeft je direct duidelijkheid. Bereken je dagelijkse vochtbehoefte op basis van gewicht, leeftijd en activiteit. Het is een handig hulpmiddel om je gezondheid te monitoren en doelen te stellen. Gebruik de resultaten als richtlijn en raadpleeg bij twijfel een arts of specialist.",
    ...
    keywords: ["waterbehoefte","vochtbehoefte","water drinken","dagelijkse vocht","waterbehoefte 2026"],
  },
  calculator: {
    componentSlug: "waterbehoefte",
    categorySlug: "gezondheid",
  },
  categoryLabel: "Gezondheid",
  faqs: [
  {
    "question": "Wat is Waterbehoefte Berekenen en hoe gebruik ik hem?",
    "answer": "Waterbehoefte Berekenen is een gratis online tool waarmee je bereken je dagelijkse vochtbehoefte op basis van gewicht, leeftijd en activiteit. Je vult de gevraagde gegevens in en het resultaat verschijnt direct. De calculator werkt met de meest actuele gegevens en tarieven, zodat je altijd een reële uitkomst krijgt. Geen registratie nodig en volledig gratis te gebruiken."
  },
  {
    "question": "Hoe nauwkeurig is Waterbehoefte Berekenen?",
  ...
  {
    "question": "In welke situaties gebruik ik Waterbehoefte Berekenen?",
  ...
  },
  {
    ...
    "answer": "Naast Waterbehoefte Berekenen zijn er op Rekenhet.nl nog meer handige calculators die je kunt gebruiken. Kijk ook eens naar de andere tools in de categorie Gezondheid. Ze vullen elkaar aan en geven je een completer beeld van je situatie."
  }
],
});
