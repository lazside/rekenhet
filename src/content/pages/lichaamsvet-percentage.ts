...
registerPages({
  slug: "lichaamsvet-percentage",
  seo: {
    title: "Lichaamsvet Percentage Berekenen | Rekenhet.nl",
    description: "Gratis lichaamsvet percentage calculator voor mannen en vrouwen.",
    h1: "Lichaamsvet Percentage — Direct inzicht in je gezondheid",
    intro: "Een gezonde leefstijl begint met inzicht. Deze Lichaamsvet Percentage geeft je direct duidelijkheid. Bereken je lichaamsvetpercentage op basis van metingen en geslacht. Het is een handig hulpmiddel om je gezondheid te monitoren en doelen te stellen. Gebruik de resultaten als richtlijn en raadpleeg bij twijfel een arts of specialist.",
    ...
    keywords: ["lichaamsvet percentage","vetpercentage","BMI alternatief","gezondheid","body fat","lichaamsvet percentage 2026"],
  },
  calculator: {
    componentSlug: "lichaamsvet-percentage",
    categorySlug: "gezondheid",
  },
  categoryLabel: "Gezondheid",
  faqs: [
  {
    "question": "Wat is Lichaamsvet Percentage en hoe gebruik ik hem?",
    "answer": "Lichaamsvet Percentage is een gratis online tool waarmee je bereken je lichaamsvetpercentage op basis van metingen en geslacht. Je vult de gevraagde gegevens in en het resultaat verschijnt direct. De calculator werkt met de meest actuele gegevens en tarieven, zodat je altijd een reële uitkomst krijgt. Geen registratie nodig en volledig gratis te gebruiken."
  },
  {
    "question": "Hoe nauwkeurig is Lichaamsvet Percentage?",
  ...
  {
    "question": "In welke situaties gebruik ik Lichaamsvet Percentage?",
  ...
  },
  {
    ...
    "answer": "Naast Lichaamsvet Percentage zijn er op Rekenhet.nl nog meer handige calculators die je kunt gebruiken. Kijk ook eens naar de andere tools in de categorie Gezondheid. Ze vullen elkaar aan en geven je een completer beeld van je situatie."
  }
],
});
