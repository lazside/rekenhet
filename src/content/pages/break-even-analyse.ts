...
registerPages({
  slug: "break-even-analyse",
  seo: {
    title: "Break-Even Analyse Berekenen | Rekenhet.nl",
    description: "Gratis break-even calculator voor minimaal aantal eenheden en omzet.",
    h1: "Break-Even Analyse — Bereken het eenvoudig en snel",
    intro: "Als ondernemer wil je grip op je cijfers. Deze Break-Even Analyse helpt je snel en eenvoudig. Bereken het aantal eenheden dat je moet verkopen om quitte te draaien. Gebruik de tool om verschillende scenario's door te rekenen en weloverwogen beslissingen te nemen voor je bedrijf.",
    ...
    keywords: ["break-even","break even analyse","kosten","omzet","winst","break even analyse 2026"],
  },
  calculator: {
    componentSlug: "break-even-analyse",
    categorySlug: "ondernemen",
  },
  categoryLabel: "Ondernemen",
  faqs: [
  {
    "question": "Wat is Break-Even Analyse en hoe gebruik ik hem?",
    "answer": "Break-Even Analyse is een gratis online tool waarmee je bereken het aantal eenheden dat je moet verkopen om quitte te draaien. Je vult de gevraagde gegevens in en het resultaat verschijnt direct. De calculator werkt met de meest actuele gegevens en tarieven, zodat je altijd een reële uitkomst krijgt. Geen registratie nodig en volledig gratis te gebruiken."
  },
  {
  ...
  {
    "question": "In welke situaties gebruik ik Break-Even Analyse?",
  ...
  },
  {
    ...
    "answer": "Naast Break-Even Analyse zijn er op Rekenhet.nl nog meer handige calculators die je kunt gebruiken. Kijk ook eens naar de andere tools in de categorie Ondernemen. Ze vullen elkaar aan en geven je een completer beeld van je situatie."
  }
],
});
