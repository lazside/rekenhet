...
registerPages({
  ...
  {
    "question": "In welke situaties gebruik ik Krediettermijn?",
  ...
  },
  {
    ...
    "answer": "Naast Krediettermijn zijn er op Rekenhet.nl nog meer handige calculators die je kunt gebruiken. Kijk ook eens naar de andere tools in de categorie Ondernemen. Ze vullen elkaar aan en geven je een completer beeld van je situatie."
  }
],
});
