...
registerPages({
  ...
  {
    "question": "In welke situaties gebruik ik Reiskosten Woon-Werk?",
  ...
  },
  {
    ...
    "answer": "Naast Reiskosten Woon-Werk zijn er op Rekenhet.nl nog meer handige calculators die je kunt gebruiken. Kijk ook eens naar de andere tools in de categorie Werk & Inkomen. Ze vullen elkaar aan en geven je een completer beeld van je situatie."
  }
],
});
