...
registerPages({
  ...
  seo: {
    title: "Schenkbelasting Berekenen 2026 | Rekenhet.nl",
    description: "Gratis schenkbelasting calculator voor 2026 met vrijstellingen.",
    h1: "Schenkbelasting Berekenen — Bereken het eenvoudig en snel",
    intro: "Of het nu gaat om belasting, spaargeld of verzekeringen — met deze Schenkbelasting Berekenen weet je waar je aan toe bent. Bereken de schenkbelasting op basis van het bedrag en de relatie. De calculator werkt met de actuele 2026-tarieven en -regels, zodat je altijd een reëel beeld krijgt.",
    ...
    keywords: ["schenkbelasting","schenking","vrijstelling","belasting","schenken 2026","schenkbelasting 2026"],
  },
  calculator: {
    componentSlug: "schenkbelasting",
    categorySlug: "geld-en-verzekeringen",
  },
  categoryLabel: "Geld & Verzekeringen",
  faqs: [
  {
    "question": "Wat is Schenkbelasting Berekenen en hoe gebruik ik hem?",
    "answer": "Schenkbelasting Berekenen is een gratis online tool waarmee je bereken de schenkbelasting op basis van het bedrag en de relatie. Je vult de gevraagde gegevens in en het resultaat verschijnt direct. De calculator werkt met de meest actuele gegevens en tarieven, zodat je altijd een reële uitkomst krijgt. Geen registratie nodig en volledig gratis te gebruiken."
  },
  {
  ...
  {
    "question": "In welke situaties gebruik ik Schenkbelasting Berekenen?",
