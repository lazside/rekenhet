...
registerPages({
  ...
  seo: {
    title: "13e Maand Berekenen — Dertiende Maand | Rekenhet.nl",
    description: "Gratis 13e maand calculator. Bereken bruto en netto dertiende maand.",
    h1: "13e Maand Berekenen — Bereken het eenvoudig en snel",
    intro: "Wil je precies weten hoeveel je overhoudt of ontvangt? Deze 13e Maand Berekenen geeft je direct inzicht. Bereken de bruto en netto waarde van een 13e maand. Of je nu werknemer of werkgever bent, binnen enkele seconden zie je het resultaat op basis van de actuele 2026-regels en tarieven.",
    ...
    keywords: ["13e maand","dertiende maand","eindejaarsuitkering","bonus","dertiende maand 2026"],
  },
  calculator: {
    componentSlug: "dertiende-maand",
    categorySlug: "werk-en-inkomen",
  },
  categoryLabel: "Werk & Inkomen",
  faqs: [
  {
    "question": "Wat is 13e Maand Berekenen en hoe gebruik ik hem?",
    "answer": "13e Maand Berekenen is een gratis online tool waarmee je bereken de bruto en netto waarde van een 13e maand. Je vult de gevraagde gegevens in en het resultaat verschijnt direct. De calculator werkt met de meest actuele gegevens en tarieven, zodat je altijd een reële uitkomst krijgt. Geen registratie nodig en volledig gratis te gebruiken."
  },
  {
  ...
  {
    "question": "In welke situaties gebruik ik 13e Maand Berekenen?",
  ...
  },
  {
    ...
    "answer": "Naast 13e Maand Berekenen zijn er op Rekenhet.nl nog meer handige calculators die je kunt gebruiken. Kijk ook eens naar de andere tools in de categorie Werk & Inkomen. Ze vullen elkaar aan en geven je een completer beeld van je situatie."
  }
],
});
