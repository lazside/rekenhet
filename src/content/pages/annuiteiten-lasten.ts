...
registerPages({
  ...
  faqs: [
  {
    "question": "Wat is Annuïtaire Maandlasten en hoe gebruik ik hem?",
    "answer": "Annuïtaire Maandlasten is een gratis online tool waarmee je bereken je bruto maandlasten voor een annuïteitenhypotheek. Je vult de gevraagde gegevens in en het resultaat verschijnt direct. De calculator werkt met de meest actuele gegevens en tarieven, zodat je altijd een reële uitkomst krijgt. Geen registratie nodig en volledig gratis te gebruiken."
  },
  {
  ...
  {
    "question": "In welke situaties gebruik ik Annuïtaire Maandlasten?",
  ...
  },
  {
    ...
    "answer": "Naast Annuïtaire Maandlasten zijn er op Rekenhet.nl nog meer handige calculators die je kunt gebruiken. Kijk ook eens naar de andere tools in de categorie Geld & Verzekeringen. Ze vullen elkaar aan en geven je een completer beeld van je situatie."
  }
],
});
