...
registerPages({
  slug: "verhuiskosten",
  seo: {
    title: "Verhuiskosten Berekenen — Verhuis Calculator | Rekenhet.nl",
    description: "Gratis verhuiskosten calculator voor totale kosten en terugverdientijd.",
    h1: "Verhuiskosten Berekenen — Bereken het eenvoudig en snel",
    intro: "Of het nu gaat om belasting, spaargeld of verzekeringen — met deze Verhuiskosten Berekenen weet je waar je aan toe bent. Bereken de totale kosten en terugverdientijd van een verhuizing. De calculator werkt met de actuele 2026-tarieven en -regels, zodat je altijd een reëel beeld krijgt.",
    ...
    keywords: ["verhuiskosten","verhuizing","kosten berekenen","terugverdientijd","verhuiskosten 2026"],
  },
  calculator: {
    componentSlug: "verhuiskosten",
    categorySlug: "geld-en-verzekeringen",
  },
  categoryLabel: "Geld & Verzekeringen",
    faqs: [
    {
      question: "Hoe wordt de berekening van verhuiskosten berekenen gemaakt?",
    ...
    {
      question: "Zijn de tarieven voor verhuiskosten berekenen up-to-date voor 2026?",
    ...
    {
      question: "Is de uitkomst van verhuiskosten berekenen bindend?",
