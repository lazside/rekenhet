...
registerPages({
  ...
  categoryLabel: "Geld & Verzekeringen",
    faqs: [
    {
      question: "Hoe wordt de berekening van aow-leeftijd gemaakt?",
    ...
    {
      question: "Zijn de tarieven voor aow-leeftijd up-to-date voor 2026?",
    ...
    {
      question: "Is de uitkomst van aow-leeftijd bindend?",
