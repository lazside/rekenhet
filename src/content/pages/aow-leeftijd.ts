...
registerPages({
  slug: "aow-leeftijd",
  seo: {
    title: "AOW Leeftijd Berekenen | Rekenhet.nl",
    description: "Gratis AOW leeftijd calculator voor je pensioenleeftijd.",
    h1: "AOW Leeftijd Berekenen — Bereken het eenvoudig en snel",
    intro: "Of het nu gaat om belasting, spaargeld of verzekeringen — met deze AOW Leeftijd Berekenen weet je waar je aan toe bent. Bereken je AOW-leeftijd en AOW-bedrag op basis van geboortedatum. De calculator werkt met de actuele 2026-tarieven en -regels, zodat je altijd een reëel beeld krijgt.",
    ...
    keywords: ["aow leeftijd","aow","pensioenleeftijd","aow datum","wanneer aow","aow leeftijd 2026"],
  },
  calculator: {
    componentSlug: "aow-leeftijd",
    categorySlug: "geld-en-verzekeringen",
  },
  categoryLabel: "Geld & Verzekeringen",
  faqs: [
  {
    "question": "Wat is AOW Leeftijd Berekenen en hoe gebruik ik hem?",
    "answer": "AOW Leeftijd Berekenen is een gratis online tool waarmee je bereken je aow-leeftijd en aow-bedrag op basis van geboortedatum. Je vult de gevraagde gegevens in en het resultaat verschijnt direct. De calculator werkt met de meest actuele gegevens en tarieven, zodat je altijd een reële uitkomst krijgt. Geen registratie nodig en volledig gratis te gebruiken."
  },
  {
  ...
  {
    "question": "In welke situaties gebruik ik AOW Leeftijd Berekenen?",
