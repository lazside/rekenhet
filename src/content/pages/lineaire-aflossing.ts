...
registerPages({
  slug: "lineaire-aflossing",
  seo: {
    title: "Lineaire Aflossing Berekenen | Rekenhet.nl",
    description: "Gratis lineaire aflossing calculator voor maandlast en totale rente.",
    h1: "Lineaire Aflossing — Bereken het eenvoudig en snel",
    intro: "Of het nu gaat om belasting, spaargeld of verzekeringen — met deze Lineaire Aflossing weet je waar je aan toe bent. Bereken de maandlasten bij een lineaire lening of hypotheek. De calculator werkt met de actuele 2026-tarieven en -regels, zodat je altijd een reëel beeld krijgt.",
    ...
    keywords: ["lineaire aflossing","lening","hypotheek","aflossen","rente","lineaire aflossing 2026"],
  },
  calculator: {
    componentSlug: "lineaire-aflossing",
    categorySlug: "geld-en-verzekeringen",
  },
  categoryLabel: "Geld & Verzekeringen",
  faqs: [
  {
    "question": "Wat is Lineaire Aflossing en hoe gebruik ik hem?",
    "answer": "Lineaire Aflossing is een gratis online tool waarmee je bereken de maandlasten bij een lineaire lening of hypotheek. Je vult de gevraagde gegevens in en het resultaat verschijnt direct. De calculator werkt met de meest actuele gegevens en tarieven, zodat je altijd een reële uitkomst krijgt. Geen registratie nodig en volledig gratis te gebruiken."
  },
  {
  ...
  {
    "question": "In welke situaties gebruik ik Lineaire Aflossing?",
  ...
  },
  {
    ...
    "answer": "Naast Lineaire Aflossing zijn er op Rekenhet.nl nog meer handige calculators die je kunt gebruiken. Kijk ook eens naar de andere tools in de categorie Geld & Verzekeringen. Ze vullen elkaar aan en geven je een completer beeld van je situatie."
  }
],
});
