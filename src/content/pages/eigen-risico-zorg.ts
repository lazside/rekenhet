...
registerPages({
  slug: "eigen-risico-zorg",
  seo: {
    title: "Eigen Risico Zorg Berekenen | Rekenhet.nl",
    description: "Gratis eigen risico calculator voor zorgkosten na eigen risico.",
    h1: "Eigen Risico Zorg — Bereken het eenvoudig en snel",
    intro: "Of het nu gaat om belasting, spaargeld of verzekeringen — met deze Eigen Risico Zorg weet je waar je aan toe bent. Bereken hoeveel zorgkosten je zelf betaalt met eigen risico. De calculator werkt met de actuele 2026-tarieven en -regels, zodat je altijd een reëel beeld krijgt.",
    ...
    keywords: ["eigen risico","zorg","zorgkosten","verzekering","ziektekosten","eigen risico zorg","eigen risico zorg 2026"],
  },
  calculator: {
    componentSlug: "eigen-risico-zorg",
    categorySlug: "geld-en-verzekeringen",
  },
  categoryLabel: "Geld & Verzekeringen",
    faqs: [
    {
      question: "Hoe wordt de berekening van eigen risico zorg gemaakt?",
    ...
    {
      question: "Zijn de tarieven voor eigen risico zorg up-to-date voor 2026?",
    ...
    {
      question: "Is de uitkomst van eigen risico zorg bindend?",
