...
registerPages({
  slug: "isde-subsidie",
  seo: {
    title: "ISDE Subsidie Berekenen 2026 | Rekenhet.nl",
    description: "Gratis ISDE subsidie calculator voor duurzame maatregelen.",
    h1: "ISDE Subsidie Berekenen — Bereken het eenvoudig en snel",
    intro: "Of het nu gaat om belasting, spaargeld of verzekeringen — met deze ISDE Subsidie Berekenen weet je waar je aan toe bent. Bereken de ISDE-subsidie voor warmtepomp, zonneboiler of isolatie. De calculator werkt met de actuele 2026-tarieven en -regels, zodat je altijd een reëel beeld krijgt.",
    ...
    keywords: ["isde subsidie","subsidie warmtepomp","duurzame energie subsidie","isolatie subsidie","isde subsidie 2026"],
  },
  calculator: {
    componentSlug: "isde-subsidie",
    categorySlug: "geld-en-verzekeringen",
  },
  categoryLabel: "Geld & Verzekeringen",
  faqs: [
  {
    "question": "Wat is ISDE Subsidie Berekenen en hoe gebruik ik hem?",
    "answer": "ISDE Subsidie Berekenen is een gratis online tool waarmee je bereken de isde-subsidie voor warmtepomp, zonneboiler of isolatie. Je vult de gevraagde gegevens in en het resultaat verschijnt direct. De calculator werkt met de meest actuele gegevens en tarieven, zodat je altijd een reële uitkomst krijgt. Geen registratie nodig en volledig gratis te gebruiken."
  },
  {
  ...
  {
    "question": "In welke situaties gebruik ik ISDE Subsidie Berekenen?",
  ...
  },
  {
    ...
    "answer": "Naast ISDE Subsidie Berekenen zijn er op Rekenhet.nl nog meer handige calculators die je kunt gebruiken. Kijk ook eens naar de andere tools in de categorie Geld & Verzekeringen. Ze vullen elkaar aan en geven je een completer beeld van je situatie."
  }
],
});
