...
registerPages({
  slug: "spaardoel",
  seo: {
    title: "Spaardoel Berekenen — Eindwaarde | Rekenhet.nl",
    description: "Gratis spaardoel calculator voor eindwaarde met rente.",
    h1: "Spaardoel Berekenen — Bereken het eenvoudig en snel",
    intro: "Of het nu gaat om belasting, spaargeld of verzekeringen — met deze Spaardoel Berekenen weet je waar je aan toe bent. Bereken de eindwaarde van sparen met maandelijkse inleg en rente. De calculator werkt met de actuele 2026-tarieven en -regels, zodat je altijd een reëel beeld krijgt.",
    ...
    keywords: ["spaardoel","sparen","rente","eindwaarde","maandelijkse inleg","spaardoel berekenen","spaardoel berekenen 2026"],
  },
  calculator: {
    componentSlug: "spaardoel-berekenen",
    categorySlug: "geld-en-verzekeringen",
  },
  categoryLabel: "Geld & Verzekeringen",
  faqs: [
  {
    "question": "Wat is Spaardoel Berekenen en hoe gebruik ik hem?",
    "answer": "Spaardoel Berekenen is een gratis online tool waarmee je bereken de eindwaarde van sparen met maandelijkse inleg en rente. Je vult de gevraagde gegevens in en het resultaat verschijnt direct. De calculator werkt met de meest actuele gegevens en tarieven, zodat je altijd een reële uitkomst krijgt. Geen registratie nodig en volledig gratis te gebruiken."
  },
  {
  ...
  {
    "question": "In welke situaties gebruik ik Spaardoel Berekenen?",
  ...
  },
  {
    ...
    "answer": "Naast Spaardoel Berekenen zijn er op Rekenhet.nl nog meer handige calculators die je kunt gebruiken. Kijk ook eens naar de andere tools in de categorie Geld & Verzekeringen. Ze vullen elkaar aan en geven je een completer beeld van je situatie."
  }
],
});
