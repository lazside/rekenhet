...
registerPages({
  ...
  faqs: [
  {
    "question": "Wat is Dividend Belasting Berekenen en hoe gebruik ik hem?",
    "answer": "Dividend Belasting Berekenen is een gratis online tool waarmee je bereken de dividendbelasting en netto dividend na belasting. Je vult de gevraagde gegevens in en het resultaat verschijnt direct. De calculator werkt met de meest actuele gegevens en tarieven, zodat je altijd een reële uitkomst krijgt. Geen registratie nodig en volledig gratis te gebruiken."
  },
  {
  ...
  {
    "question": "In welke situaties gebruik ik Dividend Belasting Berekenen?",
