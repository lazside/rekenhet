...
registerPages({
  slug: "btw-privegebruik",
  seo: {
    title: "BTW Privégebruik Berekenen — Correctie | Rekenhet.nl",
    description: "Gratis BTW privégebruik calculator voor de BTW-correctie.",
    h1: "BTW Privégebruik — Bereken het eenvoudig en snel",
    intro: "Als ondernemer wil je grip op je cijfers. Deze BTW Privégebruik helpt je snel en eenvoudig. Bereken de BTW-correctie voor privégebruik van zakelijke goederen. Gebruik de tool om verschillende scenario's door te rekenen en weloverwogen beslissingen te nemen voor je bedrijf.",
    ...
    keywords: ["btw privegebruik","btw correctie","privegebruik","ondernemer","btw privegebruik 2026"],
  },
  calculator: {
    componentSlug: "btw-privegebruik",
