...
registerPages({
  slug: "huurverhoging",
  seo: {
    title: "Huurverhoging Berekenen 2026 | Rekenhet.nl",
    description: "Gratis huurverhoging calculator voor de nieuwe huur.",
    h1: "Huurverhoging Berekenen — Bereken het eenvoudig en snel",
    intro: "Of het nu gaat om belasting, spaargeld of verzekeringen — met deze Huurverhoging Berekenen weet je waar je aan toe bent. Bereken de nieuwe huur na een huurverhoging (max 5,5% in 2026). De calculator werkt met de actuele 2026-tarieven en -regels, zodat je altijd een reëel beeld krijgt.",
    ...
    keywords: ["huurverhoging","huur","verhoging 2026","huurprijs","huurverhoging 2026"],
  },
  calculator: {
    componentSlug: "huurverhoging",
    categorySlug: "geld-en-verzekeringen",
  },
  categoryLabel: "Geld & Verzekeringen",
  faqs: [
  {
    "question": "Wat is Huurverhoging Berekenen en hoe gebruik ik hem?",
    "answer": "Huurverhoging Berekenen is een gratis online tool waarmee je bereken de nieuwe huur na een huurverhoging (max 5,5% in 2026). Je vult de gevraagde gegevens in en het resultaat verschijnt direct. De calculator werkt met de meest actuele gegevens en tarieven, zodat je altijd een reële uitkomst krijgt. Geen registratie nodig en volledig gratis te gebruiken."
  },
  {
  ...
  {
    "question": "In welke situaties gebruik ik Huurverhoging Berekenen?",
  ...
  },
  {
    ...
    "answer": "Naast Huurverhoging Berekenen zijn er op Rekenhet.nl nog meer handige calculators die je kunt gebruiken. Kijk ook eens naar de andere tools in de categorie Geld & Verzekeringen. Ze vullen elkaar aan en geven je een completer beeld van je situatie."
  }
],
});
