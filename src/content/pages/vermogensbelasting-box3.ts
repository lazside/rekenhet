...
registerPages({
  slug: "vermogensbelasting-box3",
  seo: {
    title: "Box 3 Vermogensbelasting Berekenen 2026 | Rekenhet.nl",
    description: "Gratis Box 3 calculator voor vermogensbelasting.",
    h1: "Vermogensbelasting Box 3 — Bereken het eenvoudig en snel",
    intro: "Of het nu gaat om belasting, spaargeld of verzekeringen — met deze Vermogensbelasting Box 3 weet je waar je aan toe bent. Bereken de Box 3 belasting over je vermogen in 2026. De calculator werkt met de actuele 2026-tarieven en -regels, zodat je altijd een reëel beeld krijgt.",
    ...
    keywords: ["box 3","vermogensbelasting","belasting","vermogen","sparen","beleggen","vermogensbelasting box3","vermogensbelasting box3 2026"],
  },
  calculator: {
    componentSlug: "vermogensbelasting-box3",
    categorySlug: "geld-en-verzekeringen",
  },
  categoryLabel: "Geld & Verzekeringen",
  faqs: [
  {
    "question": "Wat is Vermogensbelasting Box 3 en hoe gebruik ik hem?",
    "answer": "Vermogensbelasting Box 3 is een gratis online tool waarmee je bereken de box 3 belasting over je vermogen in 2026. Je vult de gevraagde gegevens in en het resultaat verschijnt direct. De calculator werkt met de meest actuele gegevens en tarieven, zodat je altijd een reële uitkomst krijgt. Geen registratie nodig en volledig gratis te gebruiken."
  },
  {
  ...
  {
    "question": "In welke situaties gebruik ik Vermogensbelasting Box 3?",
  ...
  },
  {
    ...
    "answer": "Naast Vermogensbelasting Box 3 zijn er op Rekenhet.nl nog meer handige calculators die je kunt gebruiken. Kijk ook eens naar de andere tools in de categorie Geld & Verzekeringen. Ze vullen elkaar aan en geven je een completer beeld van je situatie."
  }
],
});
