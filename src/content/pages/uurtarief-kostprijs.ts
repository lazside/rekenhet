...
registerPages({
  slug: "uurtarief-kostprijs",
  seo: {
    title: "Uurtarief Kostprijs Berekenen | Rekenhet.nl",
    description: "Gratis uurtarief kostprijs calculator voor je minimale tarief.",
    h1: "Uurtarief Kostprijs — Bereken het eenvoudig en snel",
    intro: "Als ondernemer wil je grip op je cijfers. Deze Uurtarief Kostprijs helpt je snel en eenvoudig. Bereken je minimale uurtarief op basis van gewenst inkomen en overhead. Gebruik de tool om verschillende scenario's door te rekenen en weloverwogen beslissingen te nemen voor je bedrijf.",
    ...
    keywords: ["uurtarief","kostprijs","zzp","tarief berekenen","overhead","uurtarief kostprijs","uurtarief kostprijs 2026"],
  },
  calculator: {
    componentSlug: "uurtarief-kostprijs",
    categorySlug: "ondernemen",
  },
  categoryLabel: "Ondernemen",
  faqs: [
  {
    "question": "Wat is Uurtarief Kostprijs en hoe gebruik ik hem?",
    "answer": "Uurtarief Kostprijs is een gratis online tool waarmee je bereken je minimale uurtarief op basis van gewenst inkomen en overhead. Je vult de gevraagde gegevens in en het resultaat verschijnt direct. De calculator werkt met de meest actuele gegevens en tarieven, zodat je altijd een reële uitkomst krijgt. Geen registratie nodig en volledig gratis te gebruiken."
  },
  {
  ...
  {
    "question": "In welke situaties gebruik ik Uurtarief Kostprijs?",
  ...
  },
  {
    ...
    "answer": "Naast Uurtarief Kostprijs zijn er op Rekenhet.nl nog meer handige calculators die je kunt gebruiken. Kijk ook eens naar de andere tools in de categorie Ondernemen. Ze vullen elkaar aan en geven je een completer beeld van je situatie."
  }
],
});
