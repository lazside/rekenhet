...
registerPages({
  slug: "studieschuld-terugbetalen",
  seo: {
    title: "Studieschuld Terugbetalen — DUO | Rekenhet.nl",
    description: "Gratis studieschuld calculator voor maandbedrag en draagkracht.",
    h1: "Studieschuld Terugbetalen — Bereken het eenvoudig en snel",
    intro: "Of het nu gaat om belasting, spaargeld of verzekeringen — met deze Studieschuld Terugbetalen weet je waar je aan toe bent. Bereken de maandelijkse aflossing van je studieschuld. De calculator werkt met de actuele 2026-tarieven en -regels, zodat je altijd een reëel beeld krijgt.",
    ...
    keywords: ["studieschuld","duo","terugbetalen","aflossen","lening","studieschuld terugbetalen","studieschuld terugbetalen 2026"],
  },
  calculator: {
    componentSlug: "studieschuld-terugbetalen",
    categorySlug: "geld-en-verzekeringen",
  },
  categoryLabel: "Geld & Verzekeringen",
  faqs: [
  {
    "question": "Wat is Studieschuld Terugbetalen en hoe gebruik ik hem?",
    "answer": "Studieschuld Terugbetalen is een gratis online tool waarmee je bereken de maandelijkse aflossing van je studieschuld. Je vult de gevraagde gegevens in en het resultaat verschijnt direct. De calculator werkt met de meest actuele gegevens en tarieven, zodat je altijd een reële uitkomst krijgt. Geen registratie nodig en volledig gratis te gebruiken."
  },
  {
  ...
  {
    "question": "In welke situaties gebruik ik Studieschuld Terugbetalen?",
  ...
  },
  {
    ...
    "answer": "Naast Studieschuld Terugbetalen zijn er op Rekenhet.nl nog meer handige calculators die je kunt gebruiken. Kijk ook eens naar de andere tools in de categorie Geld & Verzekeringen. Ze vullen elkaar aan en geven je een completer beeld van je situatie."
  }
],
});
