...
registerPages({
  ...
  categoryLabel: "Geld & Verzekeringen",
    faqs: [
    {
      question: "Hoe wordt de berekening van studieschuld terugbetalen gemaakt?",
    ...
    {
      question: "Zijn de tarieven voor studieschuld terugbetalen up-to-date voor 2026?",
    ...
    {
      question: "Is de uitkomst van studieschuld terugbetalen bindend?",
