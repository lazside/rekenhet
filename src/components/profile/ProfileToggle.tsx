...
export function ProfileToggle({
  ...
  return (
    ...
    >
      ...
      {/* Label */}
      <span className="flex-1 text-xs font-medium text-gray-600 dark:text-slate-400">
        {enabled ? (
          <>
      ...
      {enabled && (
        <button
          type="button"
          onClick={handleReset}
          className="inline-flex items-center gap-1 rounded-md px-1.5 py-1 text-[11px] font-medium text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-colors dark:text-slate-500 dark:hover:text-slate-300 dark:hover:bg-slate-800"
