    ...
    <div className="relative">
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-xl border border-gray-200 bg-white py-3.5 pl-10 pr-4 text-sm text-gray-900 shadow-sm transition-all placeholder:text-gray-400 focus:border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:placeholder:text-slate-500 dark:focus:border-blue-500"
        ...
        {query.length > 0 && (
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 flex h-6 w-6 items-center justify-center rounded-full text-gray-400 hover:bg-gray-100 hover:text-gray-600 transition-colors dark:text-slate-500 dark:hover:bg-slate-800 dark:hover:text-slate-300"
          ...
          {results.map((entry, i) => (
            <li
              ...
              className={cn(
                ...
                i < results.length - 1 && "border-b border-gray-100 dark:border-slate-800"
              )}
            >
      ...
      {isOpen && query.trim().length > 0 && results.length === 0 && (
        <div className="absolute left-0 right-0 top-full mt-2 z-50 rounded-xl border border-gray-200 bg-white p-4 text-center text-sm text-gray-400 shadow-lg dark:border-slate-700 dark:bg-slate-900 dark:text-slate-500 animate-fade-in">
