...
import { ChevronRight, Mail, MessageSquare, Lightbulb, Bug, Send, Check, Loader2, Building2 } from "lucide-react";
...
export default function ContactPage() {
  ...
  const validateAll = (): boolean => {
    ...
    for (const key of Object.keys(contactSchema) as (keyof typeof contactSchema)[]) {
      const val = key === "subject" ? subject : key === "name" ? name : key === "email" ? email : message;
